...
# Generated by qmake (2.01a) (Qt 4.7.2) on: ?? ???. 27 00:09:41 2011
# Project:  qprotractor.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile qprotractor.pro
#############################################################################
...
Makefile: qprotractor.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -o Makefile qprotractor.pro
...
install_binaries: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/kibergus/qprotractor_0.0.0/qprotractor $(INSTALL_ROOT)/usr/bin/
