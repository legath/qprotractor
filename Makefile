...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ????. 1 13:22:34 2011
# Project:  qprotractor.pro
# Template: app
# Command: /usr/bin/qmake -nocache -spec /usr/share/qt4/mkspecs/linux-g++ QMAKE_CFLAGS_RELEASE=-g\ -O2 QMAKE_CFLAGS_DEBUG=-g\ -O2 QMAKE_CXXFLAGS_RELEASE=-g\ -O2 QMAKE_CXXFLAGS_DEBUG=-g\ -O2 QMAKE_LFLAGS_RELEASE=-Wl,-Bsymbolic-functions QMAKE_LFLAGS_DEBUG=-Wl,-Bsymbolic-functions QMAKE_STRIP=: PREFIX=/usr -o Makefile qprotractor.pro
#############################################################################
...
Makefile: qprotractor.pro /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -nocache -spec /usr/share/qt4/mkspecs/linux-g++ QMAKE_CFLAGS_RELEASE=-g\ -O2 QMAKE_CFLAGS_DEBUG=-g\ -O2 QMAKE_CXXFLAGS_RELEASE=-g\ -O2 QMAKE_CXXFLAGS_DEBUG=-g\ -O2 QMAKE_LFLAGS_RELEASE=-Wl,-Bsymbolic-functions QMAKE_LFLAGS_DEBUG=-Wl,-Bsymbolic-functions QMAKE_STRIP=: PREFIX=/usr -o Makefile qprotractor.pro
...
install_binaries: first FORCE
	...
	-: $(INSTALL_ROOT)/usr/bin/qprotractor
